...
class ViewerScope
{
     ...
     */
    public function __construct($item, ViewerScope $inheritedScope = null)
    {
        $this->item = $item;
    ...
    public function pushScope()
    {
        ...
        $this->popIndex = $this->itemStack[$newLocalIndex][ViewerScope::POP_INDEX] = $this->localIndex;
        ...
        $this->itemIterator = $this->itemStack[$newLocalIndex][ViewerScope::ITEM_ITERATOR] = null;
    ...
    public function next()
    {
        ...
        if (!$this->itemIterator) {
            ...
            $this->itemStack[$this->localIndex][ViewerScope::ITEM_ITERATOR] = $this->itemIterator;
            $this->itemStack[$this->localIndex][ViewerScope::ITEM_ITERATOR_TOTAL] = $this->itemIteratorTotal;
        } else {
