...
class Backtrace
{
    ...
    private static $ignore_function_args = array(
        ...
        array('SilverStripe\\Security\\Encryptors\\PHPHashEncryptor', 'encrypt'),
        array('SilverStripe\\Security\\Encryptors\\PHPHashEncryptor', 'salt'),
        array('SilverStripe\\Security\\Encryptors\\LegacyPHPHashEncryptorEncryptor', 'encrypt'),
        array('SilverStripe\\Security\\Encryptors\\LegacyPHPHashEncryptorEncryptor', 'salt'),
        array('SilverStripe\\Security\\Encryptors\\MySQLPasswordEncryptor', 'encrypt'),
        array('SilverStripe\\Security\\Encryptors\\MySQLPasswordEncryptor', 'salt'),
        array('SilverStripe\\Security\\Encryptors\\MySQLOldPasswordEncryptor', 'encrypt'),
        array('SilverStripe\\Security\\Encryptors\\MySQLOldPasswordEncryptor', 'salt'),
        array('SilverStripe\\Security\\Encryptors\\BlowfishEncryptor', 'encrypt'),
        array('SilverStripe\\Security\\Encryptors\\BlowfishEncryptor', 'salt'),
    );
