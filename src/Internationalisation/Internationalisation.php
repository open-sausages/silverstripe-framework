...
namespace SilverStripe\Internationalisation;

use SilverStripe\Core\Config\Configurable;
use SilverStripe\Core\Injector\Injector;
use SilverStripe\Dev\Deprecation;
use SilverStripe\Internationalisation\Data\Locales;
use SilverStripe\Internationalisation\Data\Sources;
 ...
 */
class Internationalisation implements TemplateGlobalProvider
{
    use Configurable;
    ...
    public static function _t($entity, $arg = null)
    {
        ...
        if (!$default && Internationalisation::config()->uninherited('missing_default_warning')) {
    ...
    public static function parse_plurals($string)
    {
        if (strstr($string, '|') && strstr($string, '{count}')) {
            $keys = Internationalisation::config()->uninherited('default_plurals');
    ...
    public static function encode_plurals($plurals)
    {
        ...
        $forms = Internationalisation::config()->uninherited('plurals');
    ...
    public static function get_locale()
    {
        if (!self::$current_locale) {
            self::$current_locale = Internationalisation::config()->uninherited('default_locale');
        }
