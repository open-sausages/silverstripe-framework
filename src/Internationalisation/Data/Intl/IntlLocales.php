...
namespace SilverStripe\Internationalisation\Data\Intl;
...
class IntlLocales implements Locales, Resettable
{
    ...
    {
        return Locale::getDisplayName($locale, Internationalisation::get_locale());
    }
    ...
    {
        return Locale::getDisplayLanguage($code, Internationalisation::get_locale());
    }
    ...
    public function getCountries()
    {
        ...
        $collator = new Collator(Internationalisation::get_locale());
    ...
    {
        return Locale::getDisplayRegion('-' . $code, Internationalisation::get_locale());
    }
