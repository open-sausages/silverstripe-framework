...
use SilverStripe\Security\Encryptors\EncryptionFailedException;
 ...
 * version available.
 */
class BlowfishEncryptor extends PasswordEncryptor
{
    /**
     * Cost of encryption.
    ...
    public function encrypt($password, $salt = null, $member = null)
    {
        ...
        if (strpos($encryptedPassword, '$2') === false) {
            throw new EncryptionFailedException('Blowfish password encryption failed.');
        }
